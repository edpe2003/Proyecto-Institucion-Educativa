...
<body class="bgPerfil">
  <?php
  include('controller/VerDatosAlumno.php');
  ...
  <div class="container d-flex justify-content-center">
    <div class="col-12 col-sm-12 col-md-9 col-lg-7">
      <?php
      require_once DIR_TEMPLATE . '/templateVerPerfil.php';
      include(DIR_TEMPLATE . '/templateModificarPerfil.php');
      include(DIR_TEMPLATE . '/templateCambiarFondo.php');
      include(DIR_TEMPLATE . '/templateEliminarCuenta.php');
      ?>
    </div>
  </div>
