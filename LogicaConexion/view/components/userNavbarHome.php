...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse flex-row-reverse transition" id="mainNav">
            <ul class="navbar-nav">
                <li class="nav-item mx-3">
                        <a data-bs-toggle="modal" data-bs-target="#ayuda">
                            <button class="btn text-white navbarItem navBold w-100 m-1">
                                <i class="fas fa-info mx-2">
